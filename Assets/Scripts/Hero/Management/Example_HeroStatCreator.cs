...
//============================================================================================================================//
//해당 파일은 HeroManager와 같은 구성을 하고 있습니다. Stat의 생성 용도로 사용하기 위해 만들었습니다. Hero씬에서 해당 HeroManager대신 
//해당 스크립트로 Hero오브젝트를 생성후, 저장을 누르시면 생성한 오브젝트의 Stat.Json파일을 받을 수 있습니다.
//============================================================================================================================//

public class Example_HeroStatCreator : MonoBehaviour
{
