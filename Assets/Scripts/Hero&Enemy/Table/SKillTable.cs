...
public class SKillTable
{
    public Dictionary<int, skill> skillTable_Dictionary = new Dictionary<int, skill>() // 03-26 Lv 추가
    {
        ...
        { 3, new skill(3, "SkillName4", 1, 4, 1, 0 , new int[3] {0,1,-1}, new int[3] {0,1,-1  },2)},
        { 4, new skill(4, "SkillName5", 1, 5, 1, 0 , new int[3] {0,1,-1}, new int[3] {0,1,-1  },2)},
        //Archer
        ...
        { 7, new skill(7, "SkillName8", 1, 3, 0, 0 , new int[3] {0,1,-1  }, new int[3] { 0,1,-1 },2)},
        { 8, new skill(8, "SkillName9", 1, 4, 1, 0 , new int[3] {0,1,-1  }, new int[3] { 0,1,-1 },2)},
        { 9, new skill(9, "SkillName10", 1, 5, 1, 0 , new int[3] {0,1,-1  }, new int[3] {0,1,-1  },2)},
        //Babarian
        ...
        { 13, new skill(13, "SkillName14", 1, 4, 1, 0 , new int[3] {0,1,-1  }, new int[3] {0,1,-1  },2)},
        { 14, new skill(14, "SkillName15", 1, 5, 1, 0 , new int[3] {0,1,-1  }, new int[3] {0,1,-1  },2)},
        //Knight
        { 15, new skill(15, "SkillName16", 1, 1, 0, 0 ,new int[3] {0,1,2 }, new int[3] { 0,1,-1  },2)},
        { 16, new skill(16, "SkillName17", 1, 2, 0, 0 , new int[3] {0,1,-1 }, new int[3] { 0,1,-1  },2)},
        { 17, new skill(17, "SkillName18", 1, 3, 0, 0 , new int[3] {0,1,-1 }, new int[3] { 0,1,-1  },2)},
        { 18, new skill(18, "SkillName19", 1, 4, 1, 0 , new int[3] {0,1,-1 }, new int[3] { 0,1,-1  },2)},
        { 19, new skill(19, "SkillName20", 1, 5, 1, 0 , new int[3] {0,1,-1 }, new int[3] { 0,1,-1  },2)},
        //Barristan
        { 20, new skill(20, "SkillName21", 1, 1, 1, 0 ,new int[3] {0,1,2 }, new int[3] { 0,1,-1  },2)},
        { 21, new skill(21, "SkillName22", 1, 2, 1, 0 , new int[3] {0,1,-1 }, new int[3] { 0,1,-1  },2)},
        { 22, new skill(22, "SkillName23", 1, 3, 0, 0 , new int[3] {0,1,-1 }, new int[3] { 0,1,-1  },2)},
        { 23, new skill(23, "SkillName24", 1, 4, 0, 0 , new int[3] {0,1,-1 }, new int[3] { 0,1,-1  },2)},
        { 24, new skill(24, "SkillName25", 1, 5, 0, 0 , new int[3] {0,1,-1 }, new int[3] { 0,1,-1  },2)},
        //Porter
        { 25, new skill(25, "SkillName26", 1, 1, 1, 0  ,new int[3] {0,1,2 }, new int[3] {0,1,-1  },2)},
        { 26, new skill(26, "SkillName27", 1, 2, 1, 0 , new int[3] {0,1,-1 }, new int[3] {0,1,-1  },2)},
