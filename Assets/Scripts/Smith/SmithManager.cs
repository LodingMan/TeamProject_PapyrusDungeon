...
public class SmithManager : MonoBehaviour
{
    ...
    IEnumerator UpgradeTextDelay()
    {
        ...
        popupPanel.transform.DOLocalMove(new Vector3(0, 450, 0), 1f);
    }

    IEnumerator UpgradeFailed()
    {
        upgradeFailPanel.transform.DOLocalMove(new Vector3(0, 300, 0), 1f);
        yield return new WaitForSeconds(1f);
        upgradeFailPanel.transform.DOLocalMove(new Vector3(0, 450, 0), 1f);
    }
