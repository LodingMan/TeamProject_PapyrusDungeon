    ...
    public class GuildManager : MonoBehaviour
    {
        ...
        public void UnemployedHero_UI_Prefabs_UpLoad(List<GameObject> UnemployedHero)
        {
            ...
            for (int i = 0; i < UnemployedHero.Count; i++)
            {
                ...
                Current_UI_Prefabs[i].transform.GetChild(0).GetComponent<Text>().text = UnemployedHero[i].GetComponent<StatScript>().myStat.Name;
                Current_UI_Prefabs[i].transform.GetChild(1).GetComponent<Text>().text = UnemployedHero[i].GetComponent<StatScript>().myStat.Job;
        ...
        public void Load_Guild_UI_Prefabs()
        {
            ...
            for (int i = 0; i < heroManager.CurrentHeroList.Count; i++)
            {
                ...
                currentPrefab.transform.GetChild(0).GetComponent<Text>().text = heroManager.CurrentHeroList[i].GetComponent<StatScript>().myStat.Name;
                currentPrefab.transform.GetChild(1).GetComponent<Text>().text = heroManager.CurrentHeroList[i].GetComponent<StatScript>().myStat.Job;
